...
def main():
    ...
    # Step 1: Create the necessary table and load the CSV data
    ...
    # Step 2: Translate item names into Greek
    ...
    # Step 3: Initialize the classifier and classify items
    ...
    # Step 4: Create the figures using FigureMaker
    ...
    # Step 5: Setup the Dash app for visualization
